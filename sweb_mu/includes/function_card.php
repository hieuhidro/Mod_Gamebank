...
function gamebank_service($cardserial, $cardcode, $cardtype,$login){
	...
	//$gamebank_account = "thien321091"; //Thay đổi account ở đây nhap account tren gamebank cua ban	alo bạn con do ko
	
	$client = new nusoap_client("http://pay.gamebank.vn/service/cardServiceV2.php?wsdl",true);

	$result = $client->call("creditCard",array("seri"=>$cardserial,"code"=> $cardcode,"cardtype"=> $cardtype, "gamebank_account"=>$gamebank_account));
